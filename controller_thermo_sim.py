...
class ThermoSimController:
    ...
    def calculate_area_black_body(self):
        ...
        self.V_gal = float(self.model.entriesBB['Volume of Water (Gal)'].get())
        ...
        self.model.outputs['Required Area (m^2): '].insert(0, self.Af)
    ...
    def ins_tank(self):
        ...
        self.sa_tank = float(self.model.entriesTank['Surface Area of Tank (m^2)'].get())
        ...
        q = ((
            ...
            heat_transfer_coefficient * self.sa_tank * self.model.delT_ambientTemp_wallTemp
